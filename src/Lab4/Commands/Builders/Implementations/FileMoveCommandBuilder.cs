...
public class FileMoveCommandBuilder : ICommandBuilder
{
    ...
    public FileMoveCommandBuilder(ILogger logger, CommandData commandData)
    {
    ...
    public ICommand Build()
    {
        ...
        return new FileMoveCommand(_commandData.Parameters[SourcePathInd], _commandData.Parameters[DestinationPathInd]);
    }
}